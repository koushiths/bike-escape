...
function setup() {
  ...
  // Moving background
  path = createSprite(290, 120);
  path.addImage(pathImg);
  path.velocityY = -5;
  path.scale=2.3

  //creating boy running
  bike1 = createSprite(70, 500);
...
function car1() {
  player1 = createSprite( Math.round(random(100, 500)));
  player1.scale = 0.2;
...
function car2() {
  player2 = createSprite( Math.round(random(500, 320)));
  player2.scale = 0.5;
...
function car3() {
  player3 = createSprite( Math.round(random(300, 120)));
  player3.scale = 0.7;
